...
public class Student {
	...
	String university;
	String stuNo;
	/** 학번이란 필드를 만듦, 퍼블릭 등의 접근 수준이없는건 기본 접근 수준을 사용하겠단말 */
	String stuName;
	/** 이름 */
	String major;
	/** 전공 */
	...
	/** int나 String은 해당 필드의 반환타입이다. 나이 */

	/*
	 * 클래스 삼요소 : 생성자, 클래스에서 인스턴스를 만들때 생성자를 호출한다. 생성자의 중괄호=필드 안에 매개값을 넣을수 있다. 인스턴스를
	 * 만들때 기본으로 받을 값을 넣을수있다.
	 */
	Student() {
